...
module.exports = {
  ...
  caption: process.env.CAPTION || "𓆩☣︎𓆪⁣𝕼𝖀𝕰𝕰𝕹_𝕹𝖀𝕮𝕷𝕰𝕬𝕽-𝖁2𓆩☣︎𓆪⁣",
  author: process.env.PACK_AUTHER || "𝐑𝐂𝐃",
  packname: process.env.PACK_NAME || "😈",
  botname: process.env.BOT_NAME || "𓆩☣︎𓆪⁣𝕼𝖀𝕰𝕰𝕹_𝕹𝖀𝕮𝕷𝕰𝕬𝕽-𝖁2𓆩☣︎𓆪",
  ownername: process.env.OWNER_NAME || "𓆩☣︎𓆪⁣𝔢𝔯𝔢𝔫 𝔫𝔲𝔠𝔩𝔢𝔞𝔯𓆩☣︎𓆪⁣",
